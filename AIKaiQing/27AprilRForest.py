...
@app.route('/')
def index():
    return send_file('C:/Users/User/OneDrive/Documents/AI_Assignment/AirbnbUI/randomforestPricePrediction.html')

@app.route('/execute_script', methods=['POST'])
def execute_script():
    # Load the data from the CSV file
    df = pd.read_csv('C:/Users/User/OneDrive/Documents/AI_Assignment/train.csv')  # Update this path
    ...
    plot_path = 'static/scatter_plot.png'  # Save the plot in the static folder
    plt.savefig(plot_path)

    # Return the plot path and MSE to the client-side
    return jsonify({"plot_path": plot_path, "mse": mse})
